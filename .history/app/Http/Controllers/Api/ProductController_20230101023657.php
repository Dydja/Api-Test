...
class ProductController extends BaseController
{
    ...
    public function update(ProductRequest $request,Product $product,ProductUpdate $productUpdate)
    {
        ...
        $products = $productUpdate->update($request->validated(),$product);

        return $this->sendResponse(new ProductResource($products),"Produit modifié avec succès");
     ...
     */
     ...
     public function search($name)
     {
         ...
         if (!isset($products)) {
            return $this->sendError("Ce produit n'existe pas!");
        }

         return $this->sendResponse(new ProductResource($products),"Produit trouvé");
     }
}
